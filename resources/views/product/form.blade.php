<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="base_price" class="form-label">{{ __('Base Price') }}</label>
            <input type="text" name="base_price" class="form-control @error('base_price') is-invalid @enderror" value="{{ old('base_price', $product?->base_price) }}" id="base_price" placeholder="Base Price">
            {!! $errors->first('base_price', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="base_cost" class="form-label">{{ __('Base Cost') }}</label>
            <input type="text" name="base_cost" class="form-control @error('base_cost') is-invalid @enderror" value="{{ old('base_cost', $product?->base_cost) }}" id="base_cost" placeholder="Base Cost">
            {!! $errors->first('base_cost', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
